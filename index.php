...
if (!isset($_SESSION['nama'])) {
    $_SESSION['flashErr'] = "Anda Belum Login";
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    if (isset($_GET['page'])) {
                        ...
                        switch ($page) {
                            case 'Items': include "item/index.php"; break;
                            case 'Admins': include "admin/index.php"; break;
                            case 'Teams': include "tim/index.php"; break;
                        }
                    } else {
