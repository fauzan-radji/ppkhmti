...
if(isset($_SESSION['nama'])){
    $_SESSION['flashErr'] = "Kamu sudah login";
...
if(isset($_POST['submit'])){
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $_SESSION['flashSuccLog'] = "Sukses Login Sebagai ".$row['nama'];

        header("Location: ../index.php");
    }else{
        $_SESSION['flashErr'] = "Email Atau Password Salah";
    }
}
?>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg w-75 mx-auto" style="margin-top: 250px;">
